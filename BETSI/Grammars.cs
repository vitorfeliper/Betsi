...
namespace BETSI
{
    class Grammars
    {
        public static List<string> Numbers = new List<string>()
        {
            ...
            "mil"
        }; // List of Numbers { 0...1000 }

        public static Dictionary<string, int> DicNumbers = new Dictionary<string, int>()
        {
            {"zero",0},
            {"um",1},
            {"dois",2},
        ...
        public static List<string> What_Time_is_It = new List<string>()
        {
            "Que horas são?", 
            "Me fala as horas!",
            "Fala a hora!", 
        ...
        public static List<string> Which_todays_date = new List<string>()
        {
            "Qual a data de hoje?",
            "Data de hoje!!!",
            "Data de hoje agora!!!",
            "Me diga a data!!!",
            "Que dia é hoje?",
            "Me diga a data de hoje por favor!!!"
        };

        public static List<string> How_much_is_it = new List<string>()
        {
            "Quanto é",
            "Quanto é 0 dividido por 0"
        };

        public static List<string> System_Stats = new List<string>()
        {
            "Diga o status geral do sistema"
        };
    }
}
